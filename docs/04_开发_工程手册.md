...
> 产品规划：[01_产品_MVP规划与技术方案.md](./01_产品_MVP规划与技术方案.md)  
> 更新日期：2026-06-02  
...
| 序号 | 文档 | 阶段 |
|------|------|------|
| 00 | [00_全流程总览.md](./00_全流程总览.md) | 全局串联 |
| 01 | [01_产品_MVP规划与技术方案.md](./01_产品_MVP规划与技术方案.md) | 产品 |
| 02 | [02_产品_需求与原型学习指南.md](./02_产品_需求与原型学习指南.md) | 产品 |
| 03 | [03_设计_移动端设计交接指南.md](./03_设计_移动端设计交接指南.md) | 设计 |
| 04 | **04_开发_工程手册.md**（本文） | 开发·工程 |
| 05 | [05_开发_前端_移动端与PC端.md](./05_开发_前端_移动端与PC端.md) | 开发·前端 |
| 06 | [06_开发_后端_SpringBoot路线.md](./06_开发_后端_SpringBoot路线.md) | 开发·后端 |
| 07 | [07_开发_后端_Go路线.md](./07_开发_后端_Go路线.md) | 开发·后端 |
| 08 | [08_开发_Cursor协作指南.md](./08_开发_Cursor协作指南.md) | 开发·Cursor |
| 09 | [09_运维_部署与环境指南.md](./09_运维_部署与环境指南.md) | 运维 |
| 10 | [10_测试_验收与测试指南.md](./10_测试_验收与测试指南.md) | 测试 |

各文档均可同步到 Git 仓库的 `docs/` 目录。
...
[工具_批量创建GitHub仓库.sh](./工具_批量创建GitHub仓库.sh) — 在 GitHub 上创建仓库（已执行过，重复运行会跳过已存在仓库）。
...
- 全套中文命名文档（见 [00_全流程总览.md](./00_全流程总览.md)）
...
- 原始需求：`MVP产品功能清单_中文需求文档_英文界面版.docx`（本目录）
